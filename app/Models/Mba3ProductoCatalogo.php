    ...
    public function get_productos(){
        try {
            ...
            $sql = $db->prepare("SELECT INV.PRODUCT_ID AS id, INV.PRODUCT_NAME AS nombre, INV.DESCRIPTION AS descripcion,"
                ...
                ." INV.PRECIO_MINIMO_R AS precio_minimo,"
                ...
                ." INV1.Codigo_Alterno_Fiscal AS sat_producto_servicio_id, INV.PARTIDA_ARANCELARIA AS sat_fraccion_arancelaria, "
                ." INV.PRODUCT_TYPE as tipo_producto, '1' AS activo"
                ." FROM INVT_Ficha_Principal INV, INVT_Ficha_Principal_2 INV1"
                ." WHERE INV.PRODUCT_ID_CORP=INV1.Product_Id_Corp  AND INV.CORP = 'CIMSA' AND INV.TEMP_MODIFY = FALSE AND INV.PRODUCT_NAME <> '' "
                ."AND INV.UM <> '' AND INV1.Codigo_Alterno_Fiscal <> ''  ");
