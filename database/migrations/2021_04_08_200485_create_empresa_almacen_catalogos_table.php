...
class CreateEmpresaAlmacenCatalogosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('empresa_almacen_catalogos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('empresa_almacen_catalogos');
    }
}
