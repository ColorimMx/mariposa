            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Menus</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputID">Id Menú</label>
                            <input type="text" class="form-control" id="id" placeholder="Ingrese El ID"/>
                        </div>
                        <div class="form-group">
                            <label for="inputDescripcion">Menú descripción</label>
                            <input type="text" class="form-control" id="descripcion" placeholder="Ingrese la descripción del Menú"/>
                        </div>
                    </form>
                </div>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Menus Colorantes Importados';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.MenuCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'descripcion'},
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese La "Descripción para el Menú".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Menú".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputDescripcion').focus();
