...
@section('title', 'Configuración Vehicular Carta Porte SAT')
            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Configuración Vehicular Carta Porte SAT.</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content bg-danger">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputNombre">Configuración Vehicular Carta Porte SAT</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre de Configuración Vehicular"/>
                        </div>
                    </form>
                </div>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Configuración Vehicular Carta Porte SAT';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatCartaPorteConfigVehicularCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('configVehicularSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Nombre del Impuesto".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
                    ...
                    $.ajax({
                        type:"POST",
                        url: "{{route('configVehicularSat.index')}}",
                        data: {
                            id:id,
                            nombre:nombre,
                            activo:activo,
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Impuesto".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
                    ...
                    if(registro == true){
                        ...
                        Swal.fire({
                            position: 'top-end',
                            title: 'El Impuesto '+ id + ' Ya Existe!' ,
