...
@section('title', 'Subtipo De Remolque Carta Porte SAT')
            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Catálogo Subtipo De Remolque Carta Porte SAT.</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content bg-danger">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputNombre">Impuesto</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre Del Impuesto"/>
                        </div>
                    </form>
                </div>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Subtipo De Remolque Carta Porte SAT';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatCartaPorteSubTipoRemCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('remolqueSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Nombre del Subtipo De Remolque".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Subtipo De Remolque".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
