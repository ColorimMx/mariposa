...
@section('title', 'Tipo Permiso Vehicular Carta Porte SAT')
            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Catálogo Tipo Permiso Vehicular Carta Porte SAT.</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content bg-danger">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputNombre">Tipo De Permiso</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre Del Tipo De Permiso"/>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatCartaPorteTipoPermisoCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('permisosSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Nombre Del Tipo De Permiso".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Tipo De Permiso".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
