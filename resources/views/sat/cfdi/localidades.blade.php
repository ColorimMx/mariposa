            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Catálogo Localidades SAT.</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content bg-danger">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputNombre">Localidad</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre De La Localidad"/>
                        </div>
                        <div class="form-group">
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Localidades SAT ';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatLocalidadCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('localidadesSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
                    $("#btn-save"). attr("id", "btn-edit");
                    $('#title-form').html("Editando ID: "+id+ " "+titulo);
                    $('#id').val(data.id);
                    $('#nombre').val(data.nombre);
                    $('#estado_nombre').val(data.estado_id.trim()).change();
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                var estado_id = $("#estado_nombre").val();
                var activo = 1;
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Nombre del Municipio".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
                    ...
                    $.ajax({
                        type:"POST",
                        url: "{{route('localidadesSat.index')}}",
                        data: {
                            id:id,
                            nombre:nombre,
                            estado_id:estado_id,
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Municipio".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
                    ...
                    if(registro == true){
                        ...
                        Swal.fire({
                            position: 'top-end',
                            title: 'El Municipio '+ id + ' Ya Existe!' ,
