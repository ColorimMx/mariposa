...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Municipios SAT ';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatMunicipioCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('municipiosSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
