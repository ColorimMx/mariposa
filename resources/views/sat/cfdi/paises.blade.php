...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Países SAT ';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatPaisCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                ...
                $.get("{{ route('paisesSat.index') }}" +'/' + id +'/edit', function (data) {
                    $('#modal-container').modal('show');
