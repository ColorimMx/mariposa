            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Catálogo Impuestos SAT.</h3>
                    </div>
                    <div class="card-body">
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Impuestos SAT';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatImpuestoCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('impuestosSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
