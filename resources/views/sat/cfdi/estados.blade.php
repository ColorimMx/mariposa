            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Catálogo Estados SAT.</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre Del Estado"/>
                        </div>
                        <div class="form-group">
                            <label for="inputNombre">Seleccione El País</label>
                            <select class="custom-select" id="pais_nombre">
                                @foreach($satPaises as $paises)
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Estados SAT ';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatEstadoCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                ...
                {{--$.get("{{ route('estadosSat.index') }}" +'/' +id.trim(), function (data) {--}}
                $.get("{{ route('estadosSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    ...
                    $('#pais_nombre').val(item.pais_id.trim()).change();*/
                    $('#id').val(data.id);
                    $('#nombre').val(data.nombre);
                    $('#pais_nombre').val(data.pais_id.trim()).change();
                    $('#id').attr("disabled", true);

                    //console.log(data);
                    //console.log(item.id);
                    //console.log(item.nombre);
                    //console.log(item.pais_id);
                    //console.log(item.pais_nombre);
                })
            });
