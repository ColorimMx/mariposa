...
@section('title', 'Tipo De Comprobantes CFDI SAT')
            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Catálogo Tipo De Comprobantes CFDI SAT.</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content bg-danger">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputNombre">Tipo De Comprobante</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Tipo De Comprobante"/>
                        </div>
                    </form>
                </div>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Catálogo Tipo De Comprobantes CFDI SAT';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.SatTipoComprobanteCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                var id = $(this).data('id');
                $.get("{{ route('comprobantesSat.index') }}" +'/' +id.trim()+ '/edit', function (data) {
                    $('#modal-container').modal('show');
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Tipo De Comprobante".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
                    ...
                    $.ajax({
                        type:"POST",
                        url: "{{route('comprobantesSat.index')}}",
                        data: {
                            id:id,
                            nombre:nombre,
                            activo:activo,
