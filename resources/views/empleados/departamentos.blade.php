            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Departamentos Colorantes Importados.</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre Para El Departamento"/>
                        </div>
                    </form>
                </div>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Departamentos Colorantes Importados';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.DepartamentoCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                ...
                $.get("{{ route('departamentos.index') }}" +'/' + id +'/edit', function (data) {
                    $('#modal-container').modal('show');
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Nombre para el Departamento".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    if(departamento == true){
                        ...
                        Swal.fire({
                            position: 'top-end',
                            title: 'El  Departamento '+ id + ' Ya Existe!' ,
