            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Tipos de Puestos Colorantes Importados.</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-content bg-danger">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            <label for="inputNombre">Tipo de Puesto</label>
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre Para El Tipo de Puesto"/>
                        </div>
                    </form>
                </div>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            var titulo = 'Áreas Colorantes Importados';
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.PuestoTipoCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                ...
                $.get("{{ route('puestosTipo.index') }}" +'/' + id +'/edit', function (data) {
                    $('#modal-container').modal('show');
            ...
            $('body').on('click', '#btn-edit', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Nombre para el Área".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
            ...
            $('body').on('click', '#btn-save', function () {
                ...
                if(id.trim() == '' )
                {
                    ...
                    Swal.fire({
                        title: 'Error!',
                        text: 'Por Favor Ingrese El "Área".',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    });
                    $('#inputNombre').focus();
