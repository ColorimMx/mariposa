            ...
            <div class="col-12 table-responsive" >
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3 class="titulo-tabla">Áreas Colorantes Importados.</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="modal-body">
                    ...
                    <form action="javascript:void(0)" id="modal-form" name="modal-form"  method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" placeholder="Ingrese El Nombre Para El Área"/>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#data-table').DataTable( {
                "ajax": "{{route('datatable.AreaCatalogoController')}}",
                "columns":[
                    {data : 'DT_RowIndex'},
                    {data : 'id'},
                    {data : 'nombre'},
            ...
            $('body').on('click', 'button.editButton', function () {
                ...
                $.get("{{ route('areas.index') }}" +'/' + id +'/edit', function (data) {
                    $('#modal-container').modal('show');
